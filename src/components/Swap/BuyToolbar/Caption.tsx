...
import { InterfaceTrade, InvestmentTrade } from 'state/routing/types'
...
export function Trade({
  ...
  trade: InterfaceTrade<Currency, Currency, TradeType> | InvestmentTrade<Currency, Currency, TradeType>
    ...
    <>
      <Tooltip placement="bottom" icon={impact?.warning ? AlertTriangle : Info}>
        <Column gap={0.75}>
          ...
          {trade instanceof InterfaceTrade ?? (
            <RoutingDiagram trade={trade as InterfaceTrade<Currency, Currency, TradeType>} />
          )}
        </Column>
      </Tooltip>
