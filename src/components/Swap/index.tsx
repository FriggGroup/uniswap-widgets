      ...
      case 'buy':
        return (
          <TextHeader>
            ...
            <ThemedText.H2 fontPrimary>{subtitle ? subtitle : <Trans>Be the first!</Trans>}</ThemedText.H2>
          </TextHeader>
        )
      case 'sell':
        return (
          <TextHeader>
            ...
            <ThemedText.H2 fontPrimary>{subtitle ? subtitle : <Trans>Claim your profits!</Trans>}</ThemedText.H2>
          </TextHeader>
        )
      case 'swap':
        return (
          <TextHeader>
            ...
            <ThemedText.H2 fontPrimary>{subtitle ? subtitle : <Trans>Swap for fun!</Trans>}</ThemedText.H2>
          </TextHeader>
        )
    }
