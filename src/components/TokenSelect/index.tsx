...
export default memo(function TokenSelect({ collapsed, disabled, field, onSelect, value, fixed }: TokenSelectProps) {
  usePrefetchBalances()
  ...
  return (
    <>
      <TokenButton value={value} collapsed={collapsed} disabled={disabled} onClick={onOpen} fixed={fixed} />
